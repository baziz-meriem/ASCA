<template>
    ...
    <div
        class="py-4 px-20 mx-10 relative">
        ...
        <div 
          ref="top"
          class="flex mx-32 my-6">
            <div >
                <div :class="step == 0? ' h-24 w-24 ':' h-20 w-20'"
                     class="border-4 border-secondcolor rounded-full flex justify-center items-center"
                    @click="changeStep(0)">
                    <div  :class=" step == 0? '  h-20 w-20 font-extrabold text-3xl': step > 0? 'h-20 w-20 font-bold text-2xl': 'h-16 w-16 font-bold text-2xl  '"
            ...
            <div>
                ...
                >
                    <div :class="step == 1? 'h-20 w-20  font-extrabold text-3xl': step > 1? ' h-20 w-20  font-bold text-2xl ': ' h-16 w-16  font-bold text-2xl  '"
            ...
            <div>
                <div :class="step == 2? '  h-24 w-24  ' :'h-20 w-20 '"
                     class="border-4 flex justify-center items-center border-secondcolor rounded-full cursor-pointer"
                    @click="changeStep(2)">
                    <div :class=" step == 2? 'h-20 w-20  p-2 font-extrabold text-3xl': step > 2? ' h-20 w-20  p-2 font-bold text-2xl ': 'h-16 w-16  p-2 font-bold text-2xl'"
...
export default {
    setup() {
    const step = ref(0);
    const steps = [Form4Adhesion, Form1Adhesion, Form3Adhesion, Form2Adhesion];
