<template>
    ...
    <div class="text-center my-10">
        ...
        <span class="text-sm"
            >or
            <router-link to="/SignIn" class="text-primcolor">
                connect to your account
            </router-link>
        </span>
    </div>
    <div class="flex justify-center mb-20 mx-4 md:mx-0 px-20">
        <form
            class="w-3/4 bg-gray-50 rounded-lg shadow-md p-6 border border-gray-200"
        ...
        >
            <div class="-mx-3 mb-6">
                ...
                <div
                    class="mx-auto w-full block text-center text-xl font-semibold -mb-5 uppercase"
                >
                    or sign up with
                </div>
                <div class="flex items-center w-1/2 mx-auto mt-2">
                    <div
