    ...
    <div class="text-center my-10">
        <div class="flex items-center justify-center">
            <svg
                fill="none"
                viewBox="0 0 24 24"
                class="w-12 h-12 text-primcolor"
                stroke="currentColor"
            >
                <path
        ...
        <h2 class="text-4xl tracking-tight">Sign in to your account</h2>
        <span class="text-sm"
            >or
            <router-link to="/Register" class="text-primcolor">
                register a new account
            </router-link>
        </span>
    </div>
    <div class="flex justify-center mb-20 mx-4 md:mx-0">
        <form
            class="w-full max-w-xl bg-gray-50 rounded-lg shadow-md p-6 border border-gray-200"
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full flex items-center justify-between px-3 mb-3">
                    ...
                    <div class="w-1/2 text-right">
                        <router-link
                            to="/ResetPassword"
                            class="text-primcolor text-sm tracking-tight"
            ...
            await auth
                ...
                .then(() => {
                    ...
                    if (auth.getloggedUser().role === "administrateur") {
                        this.$router
                            .push({ path: "/dashboard/signalements" })
                            .then(() => {
                                this.$router.go();
                            });
                    } else if (auth.getloggedUser().role === "citoyen") {
